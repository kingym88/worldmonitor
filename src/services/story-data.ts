...
export function collectStoryData(
  ...
  signals?: { events: number; militaryFlights: number; militaryVessels: number; outages: number },
  ...
  return {
    ...
    signals: signals || { events: 0, militaryFlights: 0, militaryVessels: 0, outages: 0 },
