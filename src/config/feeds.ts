...
export const SOURCE_TIERS: Record<string, number> = {
  ...
  // Travel variant sources
  'Travel AI News': 3,
  'Hospitality Tech AI': 3,
  'AI Pricing Travel': 3,
  'Travel Industry Layoffs': 3,
  'Aviation Workforce': 3,
  'Brand Campaigns': 4,
  'Marketing News': 3,
  'Loyalty Programs': 3,
  'The Points Guy': 3,
  ...
  'Gulf Business Tourism': 3,
  'Hotelier Middle East': 3,
  'Visit Dubai': 4,
  'Saudi Tourism': 4,
  'Tourism Update Africa': 3,
  'Africa Travel Week': 3,
  'Safari News': 4,
  'Caribbean News Digital': 3,
  'LATA News': 3,
  'Mexico Tourism': 4,
  'TTR Weekly': 3,
  'Travel Daily China': 3,
  'TTG Asia': 3,
  'Tourism Australia': 4,
  'Skift Tech': 2,
  'Phocuswright Innovation': 2,
  'Travel Tech': 3,
  'Hospitality Net Tech': 3,
  'CNBC Travel': 2,
  'Bloomberg Travel': 2,
  'Yahoo Finance Travel': 3,
  'Skift Business': 2,
  'Jet Fuel Prices': 3,
  'Oil & Gas': 3,
  'State Dept Travel': 2,
...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  ai: [
    { name: 'Travel AI News', url: rss('https://news.google.com/rss/search?q=(\"travel+AI\"+OR+\"hotel+AI\"+OR+\"airline+AI\"+OR+\"AI+travel\"+OR+\"chatbot+travel\")+when:7d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Hospitality Tech AI', url: rss('https://news.google.com/rss/search?q=(\"hospitality+technology\"+OR+\"hotel+tech\"+AI+OR+\"revenue+management\"+AI)+when:7d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'AI Pricing Travel', url: rss('https://news.google.com/rss/search?q=(\"dynamic+pricing\"+OR+\"AI+pricing\"+OR+\"machine+learning\"+travel+OR+airline)+when:7d&hl=en-US&gl=US&ceid=US:en') },
  ],
  layoffs: [
    { name: 'Travel Industry Layoffs', url: rss('https://news.google.com/rss/search?q=(airline+OR+hotel+OR+\"travel+company\")+layoffs+OR+\"job+cuts\"+OR+restructuring+when:14d&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Aviation Workforce', url: rss('https://news.google.com/rss/search?q=(aviation+OR+airline+OR+airport)+workforce+OR+hiring+OR+layoffs+when:14d&hl=en-US&gl=US&ceid=US:en') },
  ],
};
